...
library Token {
    ...
    function balanceOf(
        ...
        returns (uint256)
    {
        return IIERC20(token).balanceOf(owner);
    }
    ...
    function allowance(
        ...
        returns (uint256)
    {
        return IIERC20(token).allowance(owner, spender);
    }
    ...
    function approve(
        ...
        internal
    {
        IIERC20(token).approve(spender, amount);
        ...
        internal
    {
        ...
        IIERC20(token).transfer(to, amount);
        ...
        internal
    {
        ...
        IIERC20(token).transferFrom(from, to, amount);
